...
public class ClubEleganceWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(ClubEleganceWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/ClubEleganceWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/ClubEleganceWLAIW/InitOutcome.xml").getDocumentElement();
